    ...
    public class CourseRepository(DataContext context, CustomLogger logger) : ICourse
    {
        public ServiceResponse.GeneralResponses AddOrUpdate(Course model)
        {
            ...
            catch (Exception ex)
            {
                ...
                return new GeneralResponses(false, "Error Occured!" + ex.Message);
            }
        }
        ...
        public ResponsesWithData GetStudents(string Id)
        {
            throw new NotImplementedException();
        }

        public ResponsesWithData GetTeachers(string Id)
        {
            throw new NotImplementedException();
        }
    }
